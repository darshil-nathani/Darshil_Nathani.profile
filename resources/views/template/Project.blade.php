<section class="ftco-section ftco-project" id="projects-section">
    <div class="container">
      ...
      <div class="col-md-12 heading-section text-center ftco-animate">
        ...
        <p>To translate technology into real solutions which add value to customers, and assist them in running and growing their businesses. To deliver innovative & cost-effective products and services to achive the vision whils providing an engaged work culture to our employees, all the time.</p>
      </div>
    </div>
        <div class="row">
            <div class="col-md-4">
              ...
              <div class="col-md-8">
                <div class="project img ftco-animate d-flex justify-content-center align-items-center" style="background-image: url('{{URL::asset('Asset/images/project-5.jpg')}}');">
                    <div class="overlay"></div>
                    <div class="text text-center p-4">
                        <h3><a href="#">Branding &amp; Illustration Design</a></h3>
                        <span>Web Design</span>
...
<section class="ftco-section ftco-hireme img margin-top" style="background-image: url('{{URL::asset('Asset/images/bg_1.jpg')}}')">
    <div class="container">
